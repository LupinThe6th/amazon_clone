...
return (
    <div  className="w-full h-10 bg-amazon_light text-sm text-white px-4 flex items-center">
        ...
        {userInfo && (<button onClick={handleSignOut} className="flex items-center gap-1 h-8 px-2 border border-transparent hover:border-white text-amazon_yellow cursor-pointer duration-300">
            Sign Out
        </button>)}
    </div>
);
