        ...
        <div className="flex flex-col gap-4">
            ...
            userInfo ? (
                <div className="flex flex-col items-center">
                    <button onClick={handleCheckout} className="w-full h-10 text-sm font-semibold bg-amazon_yellow cursor-pointer text-black rounded-lg hover:bg-amazon_blue hover:text-white duration-300">
                        Proceed to Checkout
                    </button>
                </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <p className="text-xs mt-3 text-red-500 font-semibold animate-bounce">Please login to Continue</p>
            </div>)
            }
        </div>
    );
